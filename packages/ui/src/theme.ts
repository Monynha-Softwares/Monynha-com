export const solutionGradientOptions = [
  'from-brand-purple to-brand-blue',
  'from-brand-pink via-brand-blue to-brand-orange',
  'from-brand-purple via-brand-pink to-brand-blue',
  'from-brand-blue via-brand-purple to-brand-pink',
] as const;

export const sectionPaddingY = 'py-24 sm:py-28';
