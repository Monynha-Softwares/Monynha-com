...
const Footer = () => {
  ...
  return (
    <footer className="bg-surface border-t border-border/60 dark:border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/solutions"
                  className="text-muted-foreground hover:text-brand-blue transition-colors ease-in-out duration-300"
                >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground/80 text-sm flex items-center space-x-1">
            <span>
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link
              to="#"
              className="text-muted-foreground/80 hover:text-brand-blue transition-colors ease-in-out duration-300 text-sm"
            >
              {t('footer.privacy')}
            </Link>
            <Link
