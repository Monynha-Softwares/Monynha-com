                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          onBlur={handleFieldBlur}
                          className="w-full px-3 py-2 border border-border rounded-xl bg-background text-foreground focus:border-brand-blue focus:ring-1 focus:ring-brand-blue focus:outline-none dark:bg-surface"
                        >
