...
export interface HomepageFeature {
  ...
  url?: string | null;
  /**
   * Controls the display order on the homepage.
   */
  orderIndex: number;
  active?: boolean | null;
  updatedAt: string;
...
export interface SiteSetting {
  ...
  description?: string | null;
  /**
   * Stores arbitrary configuration consumed by the frontend.
   */
  value:
    | {
        [k: string]: unknown;
...
export interface Lead {
  ...
  project?: string | null;
  /**
   * Details provided by the lead when contacting the team.
   */
  message: string;
  updatedAt: string;
  createdAt: string;
